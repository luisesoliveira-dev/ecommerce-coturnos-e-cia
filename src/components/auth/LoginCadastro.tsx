...
export function LoginCadastro() {
  ...
  function validarLogin(): Record<string, string> {
  ...
  // ---------- CADASTRO ----------
  function handleCadastroChange(campo: string, valor: string | boolean) {
  ...
  function validarCadastro(): Record<string, string> {
    const erros: Record<string, string> = {};
