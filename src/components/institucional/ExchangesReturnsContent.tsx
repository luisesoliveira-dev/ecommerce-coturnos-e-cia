export function ExchangesReturnsContent() {
  return (
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 text-preto/80">
            ...
            <section>
              ...
              <p className="text-base sm:text-lg leading-relaxed">
                Para informações detalhadas sobre prazos, condições do produto e
                procedimentos, entre em contato com a nossa Central de Ajuda.
              </p>
            </section>
          </div>
        </article>
