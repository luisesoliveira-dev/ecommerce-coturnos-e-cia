...
export function AppleIconDesktop() {
  return (
    <svg
      width="24"
      height="24"
...
export const InstagramIcon = ({ size = 24, className = "" }) => (
  ...
  >
    ...
    <path
      d="M12 7.5a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9zm0 7.5a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm5.25-7.75a1.05 1.05 0 1 1-2.1 0 1.05 1.05 0 0 1 2.1 0z"
      fill="#fff"
    />
  </svg>
);
...
export const YoutubeIcon = ({ size = 24, className = "" }) => (
  ...
  >
    <path
      ...
      fill="#FF0000"
    />
    <path d="M9.75 15.5l6.5-3.5-6.5-3.5v7z" fill="#fff" />
  </svg>
);
