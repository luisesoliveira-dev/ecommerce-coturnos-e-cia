...
export function ConfirmationStep() {
  return (
    ...
    >
      ...
      <div>
        <h2 className="text-4xl font-black uppercase tracking-normal leading-none">
          Pedido Realizado!
        </h2>
        <p className="text-army font-bold uppercase tracking-widest text-xs mt-4">
          Nº do Pedido: #CC-92841
        </p>
      </div>
      <p className="text-gray-500 text-sm max-w-md mx-auto">
        Enviamos um e-mail de confirmação para{" "}
        <span className="text-black font-bold">seuemail@email.com</span> com
        todos os detalhes da sua compra.
      </p>
